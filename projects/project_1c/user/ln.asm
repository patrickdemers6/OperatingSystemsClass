...
free(void *ap)
{
 ...
 6bc:	1b87b783          	ld	a5,440(a5) # 870 <freep>
 ...
 6ea:	00e6ea63          	bltu	a3,a4,6fe <free+0x50>
{
 ...
 72c:	14f73423          	sd	a5,328(a4) # 870 <freep>
}
 730:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 75e:	11653503          	ld	a0,278(a0) # 870 <freep>
 ...
 786:	0ee90913          	addi	s2,s2,238 # 870 <freep>
  if(p == (char*)-1)
 78a:	5afd                	li	s5,-1
 78c:	a88d                	j	7fe <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 78e:	00000797          	auipc	a5,0x0
 792:	0ea78793          	addi	a5,a5,234 # 878 <base>
 796:	00000717          	auipc	a4,0x0
 79a:	0cf73d23          	sd	a5,218(a4) # 870 <freep>
 79e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7c0:	0aa73a23          	sd	a0,180(a4) # 870 <freep>
      return (void*)(p + 1);
 ...
 80e:	b66080e7          	jalr	-1178(ra) # 370 <sbrk>
  if(p == (char*)-1)
