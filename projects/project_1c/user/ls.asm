...
ls(char *path)
{
 ...
 12c:	9a050513          	addi	a0,a0,-1632 # ac8 <malloc+0x11a>
 ...
 16a:	93258593          	addi	a1,a1,-1742 # a98 <malloc+0xea>
 16e:	4509                	li	a0,2
 ...
 180:	93458593          	addi	a1,a1,-1740 # ab0 <malloc+0x102>
 184:	4509                	li	a0,2
 ...
 1b2:	92a50513          	addi	a0,a0,-1750 # ad8 <malloc+0x12a>
 ...
 1f8:	8fca0a13          	addi	s4,s4,-1796 # af0 <malloc+0x142>
        printf("ls: cannot stat %s\n", buf);
 1fc:	00001a97          	auipc	s5,0x1
 200:	8b4a8a93          	addi	s5,s5,-1868 # ab0 <malloc+0x102>
...
main(int argc, char *argv[])
{
 ...
 2c2:	84250513          	addi	a0,a0,-1982 # b00 <malloc+0x152>
...
putc(int fd, char c)
{
 ...
 62e:	f56080e7          	jalr	-170(ra) # 580 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 660:	4b450513          	addi	a0,a0,1204 # b10 <digits>
 664:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 72c:	3e8b8b93          	addi	s7,s7,1000 # b10 <digits>
 ...
 86c:	2a090913          	addi	s2,s2,672 # b08 <malloc+0x15a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 934:	1f87b783          	ld	a5,504(a5) # b28 <freep>
 ...
 962:	00e6ea63          	bltu	a3,a4,976 <free+0x50>
{
 ...
 9a4:	18f73423          	sd	a5,392(a4) # b28 <freep>
}
 9a8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9d6:	15653503          	ld	a0,342(a0) # b28 <freep>
 ...
 9fe:	12e90913          	addi	s2,s2,302 # b28 <freep>
  if(p == (char*)-1)
 a02:	5afd                	li	s5,-1
 a04:	a88d                	j	a76 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 a06:	00000797          	auipc	a5,0x0
 a0a:	13a78793          	addi	a5,a5,314 # b40 <base>
 a0e:	00000717          	auipc	a4,0x0
 a12:	10f73d23          	sd	a5,282(a4) # b28 <freep>
 a16:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a38:	0ea73a23          	sd	a0,244(a4) # b28 <freep>
      return (void*)(p + 1);
 ...
 a86:	b66080e7          	jalr	-1178(ra) # 5e8 <sbrk>
  if(p == (char*)-1)
