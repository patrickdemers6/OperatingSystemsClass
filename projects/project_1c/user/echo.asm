...
free(void *ap)
{
 ...
 6e0:	1947b783          	ld	a5,404(a5) # 870 <freep>
 ...
 70e:	00e6ea63          	bltu	a3,a4,722 <free+0x50>
{
 ...
 750:	12f73223          	sd	a5,292(a4) # 870 <freep>
}
 754:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 782:	0f253503          	ld	a0,242(a0) # 870 <freep>
 ...
 7aa:	0ca90913          	addi	s2,s2,202 # 870 <freep>
  if(p == (char*)-1)
 7ae:	5afd                	li	s5,-1
 ...
 7be:	0af73b23          	sd	a5,182(a4) # 870 <freep>
 7c2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7e4:	08a73823          	sd	a0,144(a4) # 870 <freep>
      return (void*)(p + 1);
