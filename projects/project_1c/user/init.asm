...
main(void)
{
  ...
  12:	8aa50513          	addi	a0,a0,-1878 # 8b8 <malloc+0xea>
  ...
  3a:	88a90913          	addi	s2,s2,-1910 # 8c0 <malloc+0xf2>
  3e:	854a                	mv	a0,s2
  ...
  6e:	8a650513          	addi	a0,a0,-1882 # 910 <malloc+0x142>
  ...
  8c:	83050513          	addi	a0,a0,-2000 # 8b8 <malloc+0xea>
  90:	00000097          	auipc	ra,0x0
  94:	338080e7          	jalr	824(ra) # 3c8 <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	81e50513          	addi	a0,a0,-2018 # 8b8 <malloc+0xea>
  a2:	00000097          	auipc	ra,0x0
  a6:	31e080e7          	jalr	798(ra) # 3c0 <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	82c50513          	addi	a0,a0,-2004 # 8d8 <malloc+0x10a>
  ...
  d2:	82250513          	addi	a0,a0,-2014 # 8f0 <malloc+0x122>
  d6:	00000097          	auipc	ra,0x0
  da:	2e2080e7          	jalr	738(ra) # 3b8 <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	81a50513          	addi	a0,a0,-2022 # 8f8 <malloc+0x12a>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 480:	4bc50513          	addi	a0,a0,1212 # 938 <digits>
 484:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 54c:	3f0b8b93          	addi	s7,s7,1008 # 938 <digits>
 ...
 68c:	2a890913          	addi	s2,s2,680 # 930 <malloc+0x162>
        while(*s != 0){
...
free(void *ap)
{
 ...
 754:	2107b783          	ld	a5,528(a5) # 960 <freep>
 ...
 782:	00e6ea63          	bltu	a3,a4,796 <free+0x50>
{
 ...
 7c4:	1af73023          	sd	a5,416(a4) # 960 <freep>
}
 7c8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7f6:	16e53503          	ld	a0,366(a0) # 960 <freep>
 ...
 81e:	14690913          	addi	s2,s2,326 # 960 <freep>
  if(p == (char*)-1)
 822:	5afd                	li	s5,-1
 824:	a88d                	j	896 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 826:	00000797          	auipc	a5,0x0
 82a:	14278793          	addi	a5,a5,322 # 968 <base>
 82e:	00000717          	auipc	a4,0x0
 832:	12f73923          	sd	a5,306(a4) # 960 <freep>
 836:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 858:	10a73623          	sd	a0,268(a4) # 960 <freep>
      return (void*)(p + 1);
