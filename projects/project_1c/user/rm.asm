...
main(int argc, char *argv[])
{
  ...
  2e:	326080e7          	jalr	806(ra) # 350 <unlink>
...
free(void *ap)
{
 ...
 6d4:	1c07b783          	ld	a5,448(a5) # 890 <freep>
 ...
 702:	00e6ea63          	bltu	a3,a4,716 <free+0x50>
{
 ...
 744:	14f73823          	sd	a5,336(a4) # 890 <freep>
}
 748:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 776:	11e53503          	ld	a0,286(a0) # 890 <freep>
 ...
 79e:	0f690913          	addi	s2,s2,246 # 890 <freep>
  if(p == (char*)-1)
 7a2:	5afd                	li	s5,-1
 ...
 7b2:	0ef73123          	sd	a5,226(a4) # 890 <freep>
 7b6:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7d8:	0aa73e23          	sd	a0,188(a4) # 890 <freep>
      return (void*)(p + 1);
