...
free(void *ap)
{
 ...
 6c0:	19c7b783          	ld	a5,412(a5) # 858 <freep>
 ...
 6ee:	00e6ea63          	bltu	a3,a4,702 <free+0x50>
{
 ...
 730:	12f73623          	sd	a5,300(a4) # 858 <freep>
}
 734:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 762:	0fa53503          	ld	a0,250(a0) # 858 <freep>
 ...
 78a:	0d290913          	addi	s2,s2,210 # 858 <freep>
  if(p == (char*)-1)
 78e:	5afd                	li	s5,-1
 ...
 79e:	0af73f23          	sd	a5,190(a4) # 858 <freep>
 7a2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7c4:	08a73c23          	sd	a0,152(a4) # 858 <freep>
      return (void*)(p + 1);
