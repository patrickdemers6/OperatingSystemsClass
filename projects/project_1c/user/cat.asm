...
cat(int fd)
{
  ...
  44:	89858593          	addi	a1,a1,-1896 # 8d8 <malloc+0xe4>
  48:	4509                	li	a0,2
  ...
  72:	88258593          	addi	a1,a1,-1918 # 8f0 <malloc+0xfc>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 106:	80658593          	addi	a1,a1,-2042 # 908 <malloc+0x114>
 10a:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4a6:	48650513          	addi	a0,a0,1158 # 928 <digits>
 4aa:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 572:	3bab8b93          	addi	s7,s7,954 # 928 <digits>
 ...
 6b2:	27290913          	addi	s2,s2,626 # 920 <malloc+0x12c>
        while(*s != 0){
...
free(void *ap)
{
 ...
 77a:	1ca7b783          	ld	a5,458(a5) # 940 <freep>
 ...
 7a8:	00e6ea63          	bltu	a3,a4,7bc <free+0x50>
{
 ...
 7ea:	14f73d23          	sd	a5,346(a4) # 940 <freep>
}
 7ee:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 81c:	12853503          	ld	a0,296(a0) # 940 <freep>
 ...
 844:	10090913          	addi	s2,s2,256 # 940 <freep>
  if(p == (char*)-1)
 848:	5afd                	li	s5,-1
 84a:	a88d                	j	8bc <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 84c:	00000797          	auipc	a5,0x0
 850:	2fc78793          	addi	a5,a5,764 # b48 <base>
 854:	00000717          	auipc	a4,0x0
 858:	0ef73623          	sd	a5,236(a4) # 940 <freep>
 85c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 87e:	0ca73323          	sd	a0,198(a4) # 940 <freep>
      return (void*)(p + 1);
