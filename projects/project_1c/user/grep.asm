...
000000000000011a <grep>:
{
 ...
 13e:	97ea8a93          	addi	s5,s5,-1666 # ab8 <buf>
...
00000000000001de <main>:
{
 ...
 252:	80a58593          	addi	a1,a1,-2038 # a58 <malloc+0xe4>
 256:	4509                	li	a0,2
 ...
 288:	7f450513          	addi	a0,a0,2036 # a78 <malloc+0x104>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 626:	47650513          	addi	a0,a0,1142 # a98 <digits>
 62a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6f2:	3aab8b93          	addi	s7,s7,938 # a98 <digits>
 ...
 832:	26290913          	addi	s2,s2,610 # a90 <malloc+0x11c>
        while(*s != 0){
...
free(void *ap)
{
 ...
 8fa:	1ba7b783          	ld	a5,442(a5) # ab0 <freep>
 ...
 928:	00e6ea63          	bltu	a3,a4,93c <free+0x50>
{
 ...
 96a:	14f73523          	sd	a5,330(a4) # ab0 <freep>
}
 96e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 99c:	11853503          	ld	a0,280(a0) # ab0 <freep>
 ...
 9c4:	0f090913          	addi	s2,s2,240 # ab0 <freep>
  if(p == (char*)-1)
 9c8:	5afd                	li	s5,-1
 9ca:	a88d                	j	a3c <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 9cc:	00000797          	auipc	a5,0x0
 9d0:	4ec78793          	addi	a5,a5,1260 # eb8 <base>
 9d4:	00000717          	auipc	a4,0x0
 9d8:	0cf73e23          	sd	a5,220(a4) # ab0 <freep>
 9dc:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 9fe:	0aa73b23          	sd	a0,182(a4) # ab0 <freep>
      return (void*)(p + 1);
