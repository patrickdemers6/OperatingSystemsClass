...
user/_test_syscalls:     file format elf64-littleriscv
...
int main()
{
  ...
  16:	3c8080e7          	jalr	968(ra) # 3da <nice>
    startlog();
  1a:	00000097          	auipc	ra,0x0
  1e:	3b0080e7          	jalr	944(ra) # 3ca <startlog>
    if (fork() > 0)
  22:	00000097          	auipc	ra,0x0
  26:	300080e7          	jalr	768(ra) # 322 <fork>
  2a:	06a04463          	bgtz	a0,92 <main+0x92>
        sleep(5);
    uint64 count = getlog(schedlog);
  2e:	00001517          	auipc	a0,0x1
  32:	86a50513          	addi	a0,a0,-1942 # 898 <schedlog>
  36:	00000097          	auipc	ra,0x0
  3a:	39c080e7          	jalr	924(ra) # 3d2 <getlog>
  3e:	89aa                	mv	s3,a0

    // Error checking
    if (count == -1)
  40:	57fd                	li	a5,-1
  42:	04f50e63          	beq	a0,a5,9e <main+0x9e>
        return -1;
  ...
  4c:	85048493          	addi	s1,s1,-1968 # 898 <schedlog>
  50:	4901                	li	s2,0
     printf("%d %d\n", schedlog[i].pid, schedlog[i].time);
  52:	00001a17          	auipc	s4,0x1
  56:	80ea0a13          	addi	s4,s4,-2034 # 860 <malloc+0xe8>
  5a:	40d0                	lw	a2,4(s1)
  5c:	408c                	lw	a1,0(s1)
  5e:	8552                	mv	a0,s4
  60:	00000097          	auipc	ra,0x0
  64:	65a080e7          	jalr	1626(ra) # 6ba <printf>
    for (int i = 0; i < count; i++) {
  68:	0905                	addi	s2,s2,1
  6a:	04c1                	addi	s1,s1,16
  6c:	ff3917e3          	bne	s2,s3,5a <main+0x5a>
    }
  printf("---\n");
  70:	00000517          	auipc	a0,0x0
  74:	7f850513          	addi	a0,a0,2040 # 868 <malloc+0xf0>
  ...
  98:	326080e7          	jalr	806(ra) # 3ba <sleep>
  9c:	bf49                	j	2e <main+0x2e>
        return -1;
  9e:	557d                	li	a0,-1
  a0:	b7cd                	j	82 <main+0x82>
...
_main()
{
  ...
  b8:	276080e7          	jalr	630(ra) # 32a <exit>
...
gets(char *buf, int max)
{
 ...
 1aa:	19c080e7          	jalr	412(ra) # 342 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1fc:	172080e7          	jalr	370(ra) # 36a <open>
  if(fd < 0)
 ...
 20c:	17a080e7          	jalr	378(ra) # 382 <fstat>
 210:	892a                	mv	s2,a0
  close(fd);
 212:	8526                	mv	a0,s1
 214:	00000097          	auipc	ra,0x0
 218:	13e080e7          	jalr	318(ra) # 352 <close>
  return r;
}
 21c:	854a                	mv	a0,s2
...
malloc(uint nbytes)
{
 ...
 7d4:	70878793          	addi	a5,a5,1800 # ed8 <base>
 ...
 850:	b66080e7          	jalr	-1178(ra) # 3b2 <sbrk>
  if(p == (char*)-1)
